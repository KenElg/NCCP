# Code courtesy of github user cfinch, code location on github: https://github.com/cfinch/Shocksolution_Examples/blob/master/PairCorrelation/paircorrelation.py
